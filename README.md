...
**Tipp:** When dealing with a non streaming input series with many iterations it may be usefull to disable initial
iteration parsing. See `example_configs/in.json`.
